...
1. 在 **网络 --> 接口** 中将全局网络选项中的 IPv6 前缀删掉。
    ...
    ![2.png](../../assets/images/dev/vpn/bleachwrt/2.png)
...
1. 在 **iStore** 中搜索并下载 **Lucky** 插件, 下载的终端弹窗边缘变成绿色就代表完成
    ...
    ![4.png](../../assets/images/dev/vpn/bleachwrt/4.png)
...
1. 点击 **动态域名** :octicons-arrow-right-24: **添加 DDNS 任务**, 以下内容没写的都是默认, 不用改
    ...
    <!-- ![6.png](../../assets/images/dev/vpn/bleachwrt/6.png) -->
...
![8.png](../../assets/images/dev/vpn/bleachwrt/8.png)
...
2. 按 ++i++ 进入编辑模式, 在配置文件最后面添加参数
    ...
    ![9.png](../../assets/images/dev/vpn/bleachwrt/9.png)
...
1. 这里通过手机使用流量在 **Windows App** 软件远程连接内网 PC 进行测试。但是首先打开电脑的远程连接功能。
    ...
    ![11.png](../../assets/images/dev/vpn/bleachwrt/11.png)

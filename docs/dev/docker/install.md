...
### 安装方法 { id="installation-methods-1" }

在全新主机上首次安装 Docker 之前, 您需要设置 Docker apt 仓库。之后, 您可以从该仓库安装和更新 Docker。

#### 方法一：使用 `apt` 安装 { id="install-using-the-repository-1" }
...
#### 方法二：使用软件包安装 { id="install-from-a-package-1" }
...
### 安装方法 { id="installation-methods-2" }

在全新主机上首次安装 Docker 之前, 您需要设置 Docker apt 仓库。之后, 您可以从该仓库安装和更新 Docker。

#### 方法一：使用 `apt` 安装 { id="install-using-the-repository-2" }
...
#### 方法二：使用软件包安装 { id="install-from-a-package-2" }
...
### 安装方法 { id="installation-methods-3" }

在全新主机上首次安装 Docker 之前, 您需要设置 Docker apt 仓库。之后, 您可以从该仓库安装和更新 Docker。

#### 方法一：使用 `rpm` 安装 { id="install-using-the-repository-3" }
...
#### 方法二：使用软件包安装 { id="install-from-a-package-3" }

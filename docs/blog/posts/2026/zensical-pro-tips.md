...
1. **局部开启(推荐)**, 用内联样式或者自定义类使用, 这样也不会影响其他正常文本, 使用方法如下：
    ...
    ///html | div.grid.cards[style="grid-template-columns:repeat(auto-fit,minmax(min(40%,16rem),1fr))"]
    ...
    -   已开启
        ...
        __123<mark style="font-feature-settings: 'ss01' on">,</mark>435<mark style="font-feature-settings: var(--features), 'ss01' on">,</mark>400__{style="font-size:2em;"}
    ...
    |`'ss04'`|数字等高汉字|__4月21日__{style="font-size:2em; font-feature-settings: var(--features), 'ss04' off;"}|__4月21日__{style="font-size:2em; font-feature-settings: var(--features), 'ss04' on;"}|
